...
const Dashboard = () => {
  ...
  const widgets =[
    ...
    {component:<CompanyDashboardChart/>, label: 'ダッシュボードチャート', static: false, className:'w-1/3', state: true, x: 0, y: 0, w: 4, h: 2, minW: 2,isResizable:true},
    {component: <Services/>, label: '契約サービス', static: false, className:'', state: true, x: 0, y: 0, w: 2, h: 1.25, minW: 2,isResizable:false},
    {component: <Linkage/>, label: '連携サービス', static: false,className:'', state: true, x: 2, y:3 , w: 2, h: 1.25, minW: 2, isResizable:false},
    {component: <ServiceUsage/>,label: 'サービス利用状況',static: false, className: 'w-1/3', state: true, x: 0, y: 4, w: 4, h: 1.25, minW: 2, isResizable:true},
    {component: <BillingHistory/>, label: '請求履歴', static: false, className: 'w-1/3', state: true, x: 4, y: 0, w: 3, h: 2.50, minW: 2, isResizable:true},
    {component: <Notification/>,label: 'お知らせ', static: false, className: 'w-1/3', state: true,x: 4, y:2, w: 3, h: 2.25, minW: 1, isResizable:true},
    {component: <Settings showWidgets={showWidgetSettingsHandler}/>, label: '設定', static: false, className: 'w-1/3', state: true, x: 7, y: 0, w: 3, h: 2.50, isResizable:true},
    {component: <Purchase/>,label: '購入履歴', static: false, className: 'w-1/3', state: true, x: 7, y: 4, w: 3, h: 2.25, minW: 2, Resizable:true}
  ]
