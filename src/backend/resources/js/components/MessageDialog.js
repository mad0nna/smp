...
const MessageDialog = (props) => {
  return (
    <div className="rounded-lg border-2 border-gray-200 absolute inset-1/3 top-48">
      <div className="border-2 border-gray-200 min-h-message-dialog m-auto bg-primary-200 opacity-85 h-auto py-2">
        <div className="flex flex-wrap gap-0 w-full justify-start mt-8">
          <div className="flex w-full flex-wrap gap-0 text-gray-700 md:flex md:items-center mt-10">
            <div
              className="text-center w-full inline-block text-white px-3 leading-8 overflow-hidden break-words"
              style={{ width: '98%' }}
            >
              {props.message}
            </div>
