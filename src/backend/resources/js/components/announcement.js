          ...
          <div id="widget-body" className="w-full">
            {
              this.state.notificationItems.map((item, index)=>{
                ...
                return(
                  <div id="widget-content-item" className=" w-full h-20 box-border align-middle p-3 relative" key={index}>
                    <p id="item-content" className={fontColor + ' font-sans text-xs ml-2 tracking-tighter float-left'}>
