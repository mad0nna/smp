...
import Bargraph from '../../img/bar.png'
import Columngraph from '../../img/column.png'
      ...
      <div className="w-full h-full overflow-hidden relative rounded-lg border-2 border-gray-200">
        <div id="widget-header" className="max-w-full h-16 bg-white box-border align-middle py-3 relative">
          ...
          <div className="float-right w-64 h-12 text-center pt-2">
            <div className={pieBackground + ' w-16 h-6 leading-3 hover:bg-greenOld p-1 align-middle inline-block border-secondaryBg border-l-2 border-b-2 border-t-2 cursor-pointer'}>
              <p onClick={() => handleChartSelect('pie')} className=" text-black font-sans font-bold  hover:text-white text-xxs text-center">円グラフ</p>
            </div>
            <div className={columnBackground + ' w-16 h-6 leading-3 hover:bg-greenOld p-1 align-middle inline-block border-secondaryBg border-l-2 border-r-2 border-b-2 border-t-2 cursor-pointer'}>
              <p onClick={() => handleChartSelect('column')} className="text-black font-sans  hover:text-white font-bold text-xxs text-center">カラム</p>
            </div>
            <div className={barBackground + ' w-16 h-6 leading-3 hover:bg-greenOld p-1  align-middle inline-block border-secondaryBg border-r-2 border-b-2 border-t-2 cursor-pointer'}>
              <p onClick={() => handleChartSelect('bar')} className="text-black font-sans hover:text-white font-bold text-xxs text-center">棒グラフ</p>
            </div>
          </div>
...
if(document.getElementById('companyDashboard-graph')) {
  ReactDOM.render(<CompanyDashboardChart />, document.getElementById('companyDashboard-graph'))
}
