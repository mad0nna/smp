...
class CompanyProfile extends Component {
  ...
  render() {
    return (
      <div
        className="flex justify-center w-full h-full bg-gray-100"
        style={{ height: '800px' }}
      >
            ...
            <div className="flex flex-wrap gap-0 w-full justify-start">
              ...
              <div className="flex w-full flex-wrap gap-0 text-gray-700 md:flex md:items-center mt-5">
                ...
                <textarea
                  className={
                    (this.state.isEditingProfile ? '' : 'hidden') +
                    ' text-sm w-full px-3 py-2 placeholder-gray-600 border rounded focus:shadow-outline bg-gray-100 mt-2 leading-8'
                  }
                  rows={3}
                  cols={3}
                  defaultValue="企業説明をここに入力"
                />
              </div>
            </div>
        ...
        <div className="align-top inline-block w-6/12 rounded-xl border-gray-200 border h-full bg-white my-4 ml-5 mr-14 py-5 px-6">
          ...
          <div className="mx-10 mt-11 mb-2">
            ...
            <div className="flex flex-wrap gap-0 w-full justify-start">
              <div className="flex w-full flex-wrap gap-0 text-gray-700 md:flex md:items-center mt-5">
                ...
                <div className="md:w-1/2 md:flex-grow">
                  <label
                    className={
                      (this.state.isEditingContact ? 'hidden' : '') +
                      ' text-sm text-black w-full h-8 px-3 leading-8'
                    }
                  >
                    山田太郎
            ...
            <div className="flex flex-wrap gap-0 w-full justify-end mt-6 ">
              <button
                onClick={this.handleChangeContact}
                className="bg-primary-200 hover:bg-green-700 text-white  rounded-lg p-2 text-sm mr-1"
              >
                <img
                  className="inline mr-2"
                  src={this.state.isEditingContact ? saveIcon : editIcon}
                />
