...
const CompanyBilling = () =>{
  ...
  const billingList= [
    {no: 'INV00024143', billingName: 'KOT-TM定期購読', billingDate: '2021年5月1日', dueDate: '2021年5月31日', amount: '¥10,890', paidOn: '-', status: '未払い'},
    ...
    {no: 'INV00023561', billingName: 'KOT-TM 定期購読', billingDate: '2021年3月1日', dueDate: '2021年3月31日', amount: '¥10,890', paidOn: '2021年3月28日', status: '支払い済み'},
    {no: 'INV00012456', billingName: 'KOT-XC 定期購読', billingDate: '2021年2月1日', dueDate: '2021年2月28日', amount: '¥1,542,000', paidOn: '2021年2月20日', status: '支払い済み'},
    {no: 'INV00073895', billingName: 'KOT-SM 定期購読', billingDate: '2021年1月1日', dueDate: '2021年1月31日', amount: '¥5,040,220', paidOn: '2021年1月25日', status: '支払い済み'},
    {no: 'INV00072546', billingName: 'KOT-RT 定期購読', billingDate: '2020年12月1日', dueDate: '2020年12月31日', amount: '¥78,505,500', paidOn: '2020年12月22日', status: '支払い済み'},
    {no: 'INV00023451', billingName: 'KOT-WH 定期購読', billingDate: '2020年11月1日', dueDate: '2020年11月30日', amount: '¥2,024,520', paidOn: '2020年11月28日', status: '支払い済み'},
    {no: 'INV00078511', billingName: 'KOT-NB 定期購読', billingDate: '2020年10月1日', dueDate: '2020年10月31日', amount: '¥3,359,950', paidOn: '2020年10月29日', status: '支払い済み'},
    {no: 'INV00065224', billingName: 'KOT-RT 定期購読', billingDate: '2020年9月1日', dueDate: '2020年9月30日', amount: '¥11,520', paidOn: '2020年9月27日', status: '支払い済み'},
    {no: 'INV00012575', billingName: 'KOT-SL 定期購読', billingDate: '2020年8月1日', dueDate: '2020年8月31日', amount: '¥45,234,770', paidOn: '2020年8月19日', status: '支払い済み'},
  ]
    ...
    <div className="relative px-10 py-5 bg-mainbg">
            ...
            <tbody className="transform even:bg-gray-500">
              {
                billingList.map((item, index) => {
                  let txtalign = (item.paidOn === '-') ? 'text-left pl-24' : 'text-left pl-12'
                  let txtcolor = (item.status ==='未払い') ? 'text-red-500' : 'text-gray-900'
                  return (
                    <tr className="stripe-table-row h-16 2xl:text-base lg:text-sm text-gray-900" key={index}>
                      ...
                      <td className="text-left"><img src={PdfIcon} className="mx-auto w-6 h-auto"/> </td>
                    </tr>
                  )
                })
              }
      ...
      <div id="billing-pagination" className="w-full h-12 p-3 text-center space-x-2">
        ...
        <div className="inline-block text-primary-200">
          <span className="text-white rounded-2xl bg-primary-200 px-3 py-1">1</span>
