          ...
          <div className="mx-10 mt-11 mb-5">
            ...
            <div className="flex flex-wrap gap-0 w-full justify-start">
              ...
              <div className="flex w-full flex-wrap gap-0 text-gray-700 md:flex md:items-center mt-5">
                ...
                <div className="md:w-2/3 md:flex-grow">
                  <label className={(this.state.isEditingProfile ? 'hidden' : '') + ' text-sm text-black w-full h-8 px-3 leading-8'} >9999ABCDEFG</label>
                  <input className={(this.state.isEditingProfile ? '' : 'hidden') + ' text-sm w-full h-8 px-3 py-2 placeholder-gray-600 border rounded focus:shadow-outline bg-gray-100 leading-8'} type="textarea" defaultValue="9999ABCDEFG"/>
                </div>
              </div>
              ...
              <div className="flex w-full flex-wrap gap-0 text-gray-700 md:flex md:items-center mt-5">
                ...
                <div className="md:w-2/3 md:flex-grow">
                  <label className={(this.state.isEditingProfile ? 'hidden' : '') + ' text-sm text-black w-full h-8 px-3 leading-8'} >300人 - 500人</label>
                  <input className={(this.state.isEditingProfile ? '' : 'hidden') + ' text-sm w-full h-8 px-3 py-2 placeholder-gray-600 border rounded focus:shadow-outline bg-gray-100 leading-8'} type="textarea" defaultValue="300人 - 500人"/>
                </div>
              </div>
