...
class SalesLogin extends Component {
  constructor (props) {
    super(props)
    this.state = {
      email: null,
  ...
  render (){
    ...
    return(
      <div className="">
        <img src={bgIcon} className="absolute 2xl:w-9/12 xl:w-full" style={{opacity: '0.70', position: 'absolute', left: '0px', bottom: '0px', overflow: 'visible'}}/>      
          ...
          <div className="rounded-xl h-82 bg-white shadow-sm mt-32">
            ...
            <div className="bg-gray-100 rounded-b-xl" style={{filter: 'drop-shadow(0px 3px 6px rgba(0, 0, 0, 0.161))', minHeight: '314px', overflow: 'auto'}}>
              <div className="text-lg text-2xl text-center font-bold my-6 " style={{color: '#5B5B5B'}}> 
                <img className= "inline" src={folderIcon} /><span>販売代理店</span>
              </div>
