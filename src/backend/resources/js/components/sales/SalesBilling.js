...
const SalesBilling = () => {
  const billingList = [
    ...
    {
      no: 'INV00023647',
      invoiceName: 'KOT-FX 定期購読',
      billingDate: '2021年9月1日',
      dueDate: '2021年9月30日',
      amount: '¥1,567,400',
      paidOn: '2020年9月25日',
      state: '支払い済み'
    ...
    {
      no: 'INV00045254',
      invoiceName: 'KOT-RN 定期購読',
      billingDate: '2021年8月1日',
      dueDate: '2021年8月31日',
      amount: '¥19,954,000',
      paidOn: '2020年8月20日',
      state: '支払い済み'
    ...
    {
      no: 'INV00026485',
      invoiceName: 'KOT-NO 定期購読',
      billingDate: '2020年7月1日',
      dueDate: '2020年7月31日',
      amount: '¥204,500',
      paidOn: '2020年7月15日',
      state: '支払い済み'
          ...
          <table className="stripe-table-row w-full h-auto text-left zebra-striped 2xl:text-base lg:text-sm md:text-sm">
            ...
            <tbody className="transform even:bg-gray-500">
              {billingList.map((item, index) => {
                ...
                return (
                  <tr
                    className="stripe-table-row h-16 text-gray-900 my-2"
                    key={index}
                  >
...
if (document.getElementById('salesBilling')) {
  ReactDOM.render(<SalesBilling />, document.getElementById('salesBilling'))
}
