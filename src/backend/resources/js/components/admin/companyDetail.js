          ...
          <div id="companyDetail" className=" pl-20 mt-5">
            ...
            <div className="w-full h-96 pl-10 py-5">
              ...
              <div id="contact-content" className="h-auto w-full space-y-3">
                <div id="content-row">
                  <div id="content-col-header" className="h-8 w-2/6 inline-block">
                  ...
                  <div id="content-col-value" className="h-8 w-1/2 inline-block">
                    <div id="content-value">
                      <p className="text-sm text-gray-600 font-bold font-sans">株式会社町田</p>
                    </div>
                  </div>
                </div>
                <div id="content-row">
                  ...
                  <div id="content-col-value" className="h-8 w-1/2 inline-block">
                    <div id="content-value">
                      <p className="text-sm text-gray-600 font-bold font-sans">東京都江東区荒池1-5-2</p>
                    </div>
                  </div>
                </div>
                <div id="content-row">
                  ...
                  <div id="content-col-value" className="h-8 w-1/2 inline-block">
                    <div id="content-value">
                      <p className="text-sm text-gray-600 font-bold font-sans">03-1234-5678 </p>
                    </div>
                  </div>
                </div>
                <div id="content-row">
                  <div id="content-col-header" className="h-8 w-2/6 inline-block">
                    <div id="logo-container" className="inline-block mr-4">
                      <img src={CompanyAccountIconGray} alt="" className="mt-2"/>
                    </div>
                    <div id="header-name" className="inline-block">
                      <p className="text-sm text-gray-400 font-sans">顧客企業 ID</p>
                    </div>
                  </div>
                  <div id="content-col-value" className="h-8 w-1/2 inline-block">
                    <div id="content-value">
                      <p className="text-sm text-gray-600 font-bold font-sans">9999ABCDEFG</p>
                    </div>
                  </div>
                </div>
                <div id="content-row">
                  <div id="content-col-header" className="h-8 w-2/6 inline-block">
                    ...
                    <div id="header-name" className="inline-block">
                      <p className="text-sm text-gray-400 font-sans">従業員数</p>
                    </div>
                  </div>
                  <div id="content-col-value" className="h-8 w-1/2 inline-block">
                    <div id="content-value">
                      <p className="text-sm text-gray-600 font-bold font-sans">300人 - 500人</p>
                    </div>
                  </div>
                </div>
              </div>
