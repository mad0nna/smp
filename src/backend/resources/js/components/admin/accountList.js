...
const AccountList = () =>{
  const [state, setState] = useState({
    ...
    masterListOfAccounts: [
      {num: 1, httId: '1234ABCDEFG', name: '英碕株式会社', type: '販売代理店', typeEng: 'sales', contactPerson: '矢崎紘一', email: 'eiji@h-t.co.jp', telNum: '080-1234-5678'},
      {num: 2, httId: '4567ABCDEFG', name: 'ソフトバンク株式会社', type: '顧客企業', typeEng:'company', contactPerson: '山姥ひるみ', email: 'softbank@h-t.co.jp', telNum: '080-2234-6778'},
      {num: 3, httId: '8901ABCDEFG', name: 'ヤマハ株式会社', type: '販売代理店', typeEng: 'sales', contactPerson: '山崎ミリー', email: 'yamaha@h-t.co.jp', telNum: '080-1240-9263'},
      {num: 4, httId: '2345ABCDEFG', name: '日本電信株式会社', type: '顧客企業', typeEng:'company', contactPerson: '小林健太', email: 'nippontele@h-t.co.jp', telNum: '080-1684-2356'},
      {num: 5, httId: '2469ABCDEFG', name: 'みずほ銀行株式会社', type: '顧客企業', typeEng:'company', contactPerson: '愛子ミラ', email: 'mizhuo@h-t.co.jp', telNum: '080-3579-1248'},
      {num: 6, httId: '1249ABCDEFG', name: '株式会社花の力', type: '顧客企業', typeEng:'company', contactPerson: '大島希子', email: 'flowerpower@h-t.co.jp', telNum: '080-2568-9778'},
      {num: 7, httId: '4686ABCDEFG', name: '株式会社広美', type: '販売代理店', typeEng: 'sales', contactPerson: '中山智', email: 'hiromi@h-t.co.jp', telNum: '080-8943-1235'}
    ],
    listOfAccounts: [
      {num: 1, httId: '1234ABCDEFG', name: '英碕株式会社', type: '販売代理店', typeEng: 'sales', contactPerson: '矢崎紘一', email: 'eiji@h-t.co.jp', telNum: '080-1234-5678'},
      {num: 2, httId: '4567ABCDEFG', name: 'ソフトバンク株式会社', type: '顧客企業', typeEng:'company', contactPerson: '山姥ひるみ', email: 'softbank@h-t.co.jp', telNum: '080-2234-6778'},
  ...
  return (
    <div className="relative px-10 py-5 bg-mainbg">
        ...
        <div id="widget-header" className="max-w-full h-32 bg-white box-border align-middle p-4 relative">
          ...
          <div id="widget-name" className="float-right mr-12">
            <div className="table-cell h-24 w-full align-middle relative group">
              <div id="search-bar" className="border-2 border-primary-200 h-12 rounded-xl w-48 mx-0 my-auto bg-white table-cell align-middle relative cursor-pointer">
                <p className="mx-0 my-auto w-48 inline ml-8 text-gray-400 text-sm font-bold">絞り込み</p>
              ...
              <div className="w-full h-46 bg-greenOld absolute -bottom-18 z-10 py-4 px-8 hidden group-hover:block">
                <div id="sortItem" className="w-full h-12">
                  <a href="#" className=" space-x-2 ">
                    ...
                    <div className="inline-block">
                      <div className="table-cell align-middle h-12">
                        <div className="inline-block  my-auto mx-0 text-white text-center" onClick={()=>{selectFilter('All')}}>すべて</div>
                      </div>
                    </div>
                  </a>
                </div>
                <div id="sortItem" className="w-full h-12">
                  <a href="#" className=" space-x-2 ">
                    ...
                    <div className="inline-block">
                      <div className="table-cell align-middle h-12">
                        <div className="inline-block  my-auto mx-0 text-white text-center" onClick={()=>{selectFilter('sales')}}>販売代理店</div>
                      </div>
                    </div>
                  </a>
                </div>
                <div id="sortItem" className="w-full h-12">
                  <a href="#" className="space-x-2">
                    ...
                    <div className="inline-block">
                      <div className="table-cell align-middle h-12">
                        <div className="inline-block  my-auto mx-0 text-white  text-center" onClick={()=>{selectFilter('company')}}>顧客企業</div>
                      </div>
                    </div>
                  </a>
                </div>
          ...
          <div id="widget-name" className="float-right mr-12">
            <div className="table-cell relative h-24 w-full align-middle">
              <div id="search-bar" className="bg-mainbg h-12 rounded-3xl w-96 mx-0 my-auto">
                ...
                <input type="text" id="billingSearch" className="h-full w-80 bg-mainbg custom-outline-none" placeholder="検索" onChange={(e)=>{searchFor(e.target.value)}}/>
              </div>
            </div>
          </div>
          <div>
            ...
            <thead className="bg-table-header-Gray-100 text-table-header-Gray-400 h-3 font-bold text-lg tracking-tight">
              <tr className="h-12 w-12">
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('num')}/>
                  <span id='num' onClick={()=>{handleSort('num')}}>No.</span>
                </td>
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('httId')}/>
                  <span id='httId' onClick={()=>{handleSort('httId')}}>HTT-ID</span>
                </td>
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('name')}/>
                  <span id='name' onClick={()=>{handleSort('name')}}>アカウント名</span>
                </td>
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('type')}/>
                  <span id='type' onClick={()=>{handleSort('type')}}>アカウント種類</span>
                </td>
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('contactPerson')}/>
                  <span id='contactPerson' onClick={()=>{handleSort('contactPerson')}}>連絡担当者</span>
                </td>
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('email')}/>
                  <span id='email' onClick={()=>{handleSort('email')}}>メールアドレス</span>
                </td>
                <td className="group cursor-pointer">
                  <div className={'inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active ' + activeSortingIcon('telNum')}/>
                  <span id='telNum' onClick={()=>{handleSort('telNum')}}>電話番号</span>
                </td>
                <td>
                  <span>操作</span>
                </td>
      ...
      <div id="billing-pagination" className="w-full h-12 p-3 text-center space-x-2 mt-4">
        <img src={PrevButton} className="inline-block w-8 h-auto cursor-pointer mb-1"/>
        ...
        <img src={NextButton} className="inline-block  w-8 h-auto cursor-pointer mb-1"/>
      </div>
    </div>
  )
}
