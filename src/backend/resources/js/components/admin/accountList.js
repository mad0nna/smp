...
const AccountList = () =>{
  const listOfAccounts = [
    {num: 1, httId: '1234ABCDEFG', name: '英碕株式会社', type: '販売代理店', contactPerson: '矢崎紘一', email: 'eiji@h-t.co.jp', telNum: '080-1234-5678'},
    {num: 2, httId: '4567ABCDEFG', name: 'ソフトバンク株式会社', type: '顧客企業', contactPerson: '山姥ひるみ', email: 'softbank@h-t.co.jp', telNum: '080-2234-6778'},
    {num: 3, httId: '8901ABCDEFG', name: 'ヤマハ株式会社', type: '販売代理店', contactPerson: '山崎ミリー', email: 'yamaha@h-t.co.jp', telNum: '080-1240-9263'},
    {num: 4, httId: '2345ABCDEFG', name: '日本電信株式会社', type: '顧客企業', contactPerson: '小林健太', email: 'nippontele@h-t.co.jp', telNum: '080-1684-2356'},
    {num: 5, httId: '2469ABCDEFG', name: 'みずほ銀行株式会社', type: '顧客企業', contactPerson: '愛子ミラ', email: 'mizhuo@h-t.co.jp', telNum: '080-3579-1248'},
    {num: 6, httId: '1249ABCDEFG', name: '株式会社花の力', type: '顧客企業', contactPerson: '大島希子', email: 'flowerpower@h-t.co.jp', telNum: '080-2568-9778'},
    {num: 6, httId: '4686ABCDEFG', name: '株式会社広美', type: '販売代理店', contactPerson: '中山智', email: 'hiromi@h-t.co.jp', telNum: '080-8943-1235'}
  ]
  return (
          ...
          <div id="widget-name" className="float-right mr-12">
            <div className="table-cell h-24 w-full align-middle relative group">
              <div id="search-bar" className="border-2 border-primary-200 h-12 rounded-xl w-48 mx-0 my-auto bg-white table-cell align-middle relative cursor-pointer">
                <p className="mx-0 my-auto w-48 inline ml-8 text-gray-400 text-sm font-bold">並び替え</p>
                <img src={ArrowDown} className="absolute top-3 right-3"/>
              </div>
              <div className="w-full h-32 bg-greenOld absolute -bottom-18 z-10 py-4 px-8 hidden group-hover:block">
                <div id="sortItem" className="w-full h-12">
                  <a href="#" className=" space-x-2 ">
                    ...
                    <div className="inline-block">
                      <div className="table-cell align-middle h-12">
                        <div className="inline-block  my-auto mx-0 text-white text-center">販売代理店</div>
                      </div>
                    </div>
                  </a>
                </div>
                <div id="sortItem" className="w-full h-12">
                  <a href="#" className="space-x-2">
                    <div className="inline-block">
                      <div className="table-cell align-middle h-12">
                        <div className="bg-no-repeat bg-cover bg-company-icon-gray w-6 h-6 my-auto mx-0"/>
                      </div>
                    </div>
                    <div className="inline-block">
                      <div className="table-cell align-middle h-12">
                        <div className="inline-block  my-auto mx-0 text-white  text-center">顧客企業</div>
                      </div>
                    </div>
                  </a>
                </div>
            ...
            <thead className="bg-table-header-Gray-100 text-table-header-Gray-400 h-3 font-bold text-lg tracking-tight">
              <tr className="h-12 w-12">
                <td className="group cursor-pointer">
                  <div className="inline-block h-4 w-4 bg-cover bg-no-repeat mr-2 bg-sort-icon-inactive group-hover:bg-sort-icon-active"/>
                ...
                listOfAccounts.map((item, index)=> {
                  return(
                    <tr className="stripe-table-row h-20 font-sans font-bold text-sm text-gray-600" key={index}>
                      ...
                      <td className="w-12 cursor-pointer">{item.email}</td>
                      <td className="w-12 cursor-pointer">{item.telNum}</td>
                      <td className="w-12 cursor-pointer">
                        <a href="#">
