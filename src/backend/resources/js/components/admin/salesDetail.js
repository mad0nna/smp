...
const SalesDetail = () => {
  const [state] = useState({
    companyList: [
      {httId: '0000-0001', companyName:'今井運送株式会社', numOfEmp: '100-150', contact: '竜崎すばる', email: 'subaru@sample.com', telephone: '080-1234-5678'},
      {httId: '0000-0002', companyName:'Ocean生命株式会社', numOfEmp: '200-250', contact: '如月蛍', email: 'hotaru@sample.com', telephone: '080-1234-5678'},
      {httId: '0000-0003', companyName:'株式会社ロメロ', numOfEmp: '300-350', contact: '水無川八雲', email: 'yakumo@sample.com', telephone: '080-1234-5678'},
      {httId: '0000-0004', companyName:'大沼酒造有限会社', numOfEmp: '50-100', contact: '工藤力也', email: 'rikiya@sample.com', telephone: '080-1234-5678'},
      {httId: '0000-0005', companyName:'大友建設合同会社', numOfEmp: '200-250', contact: '藤堂源治', email: 'genji@sample.com', telephone: '080-1234-5678'},
      {httId: '0000-0006', companyName:'青森園芸株式会社', numOfEmp: '300-350', contact: '大渡あかね', email: 'akane@sample.com', telephone: '080-1234-5678'}
    ],
    billingHistoryList: [
      {invDate: '2021年4月1日', dueDate: '2021年4月30日', quantity: '¥57,800,300', status: '未払い'},
      {invDate: '2021年3月1日', dueDate: '2021年3月31日', quantity: '¥6,450,520', status: '支払い済み'},
      {invDate: '2021年2月1日', dueDate: '2021年2月28日', quantity: '¥548,330', status: '未払い'},
      {invDate: '2021年1月1日', dueDate: '2021年1月31日', quantity: '¥228, 180', status: '支払い済み'},
      {invDate: '2020年12月1日', dueDate: '2020年12月31日', quantity: '¥1,650,330', status: '支払い済み'},
      {invDate: '2020年11月1日', dueDate: '2020年11月5日', quantity: '¥1,650,330', status: '未払い'}
    ]
  })
  return (
    <div className="relative px-10 pt-5 pb-0 bg-mainbg font-sans">
      ...
      <div id="contact-persons" className="w-full relative rounded-lg border-2 border-gray-200 h-48 mt-5 bg-white mb-10 flex">
            ...
            <div id="content-row">
              ...
              <div id="content-col-value" className="h-8 w-1/2 inline-block">
                <div id="content-value">
                  <p className="text-sm text-gray-600 font-bold font-sans">サンプル業務名</p>
                </div>
              </div>
            </div>
            <div id="content-row">
              ...
              <div id="content-col-value" className="h-8 w-1/2 inline-block">
                <div id="content-value">
                  <p className="text-sm text-gray-600 font-bold font-sans">商社</p>
                </div>
              </div>
            </div>
            <div id="content-row">
              ...
              <div id="content-col-value" className="h-8 w-1/2 inline-block">
                <div id="content-value">
                  <p className="text-sm text-gray-600 font-bold font-sans">サンプル住所</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="companies&billing" className="w-full h-detail-height flex mb-3 mt-8 space-x-12">
        <div id="companyList" className="w-1/2 h-full border-2 border-gray-200 bg-white">
        ...
        <div id="admin-sales-billing" className="w-1/2 h-full border-2 border-gray-200 bg-white rounded-lg">
          <div id="contact-logo-container" className="h-16 flex mb-2  px-4 pb-2 pt-5 ">
