          ...
          <div className="table-cell align-middle">
            <div className="mx-0 my-auto relative flex">
              <div className="w-48">
                ...
                <div className="absolute bottom-8 left-3 text-white text-xs">
                  <p>登録済み顧客企業</p>
                </div>
              </div>
              <div className="block w-full">
                <div className="text-center mt-4">
                  <p className="2xl:text-5xl lg:text-4xl lg:mt-6 text-cyan font-black">500</p>
                </div>
                <div className="text-center">
                  <p className="2xl:text-2xl lg:text-1xl text-primary-200 font-bold">5 月度</p>
                </div>
              </div>
            </div>
          </div>
