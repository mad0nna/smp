...
import SmartHRlogo from '../../../img/admin/smarthr-logo.png'

// const AdminSmartHRServiceUsage = (props) => {
const AdminSmartHRServiceUsage = () => {
  //   let showMoveButton = ''
        ...
        <div id="widget-body" className="w-full px-3 text-gray-500">
          <div className="flex pl-1">
            ...
            <div className="flex-none">
              <img src={SmartHRlogo} className="h-24 my-auto mr-7" />
            </div>
          </div>
        </div>
        <div
          id="widget-footer"
          className="w-full px-3 text-gray-500 text-xs"
        ></div>
      </div>
    </div>
  )
}
export default AdminSmartHRServiceUsage
