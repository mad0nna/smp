...
class Notification extends React.Component {
  ...
  render() {
    return(
      <div className="w-full h-full bg-blue-400 rounded-lg border-2 border-gray-400 overflow-hidden">
        <div id="widget-header" className="max-w-full h-12 bg-white box-border align-middle p-3 relative">
          ...
          <img className="absolute w-5 h-1 top-1.5 right-6" src={Ellipsis}/>
        </div>
        <div id="widget-body" className="h-widgetBody w-full bg-mainbg py-2 space-y-2">
          {
            this.notificationItems.map((item, index)=>{
