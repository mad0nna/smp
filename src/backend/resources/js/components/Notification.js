...
class Notification extends React.Component {
  ...
  render() {
    ...
    this.props.displayType !== 'undefined' && this.props.displayType === 'small'
    ...
    return (
      <div className="w-full h-full relative group ">
        <div
          className={
            'absolute w-12 h-5 -top-4 px-1 pt-0.5 right-6 text-center font-sans text-gray-500 font-sans text-xxs leading-2 rounded-md border-gray-200 border-2 cursor-move hidden ' +
            showMoveButton
          }
        >
          Move
            ...
            {this.state.notificationItems.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className={
                    py +
                    ' bg-white w-full box-border align-middle px-3 relative'
                  }
                  key={index}
                >
                  <div
                  ...
                  >
                    ...
                    <span className="text-primary-200">
                      {this.notifWithLink.includes(item.header)
                        ? ' こちらをクリックして確認してください'
                        : ''}
                    </span>
                  </p>
