				...
				<div class="justify-content-center" style="min-width:170px">
					<div id="nav-dropdown" name="nav-dropdown" class="relative d-flex  pe-auto" style="height:28px" >
						<div class="my-auto">
							...
							@endphp
							<p class="text-base h6 fs-6 text-tertiary-500 px-2 pt-1 font-sans" id="companyDropwdownTitle" style="font-size: 1.1rem!important; font-weight: 600!important; text-shadow: 1px 1px 2px #e8e8e8;">@php echo $user['last_name'] . ' ' . $user['first_name'] @endphp</p>
