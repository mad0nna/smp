	...
	<body class="light">
		<div class="app-menu shadow-lg navbar navbar-expand-lg bg-white mb-8" style="height:6rem; z-index:1200">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample07" style="overflow:hidden; position: relative; left: -10px;">
					<ul class="navbar-nav">
						<li class="nav-item-element" style="width:144px; height:103px">
							<!-- Normal -->
							<a href="/admin/dashboard" class="nav-link original">
								<div class="mt-3">
									<div class="bg-dashboard-icon d-flex justify-content-center align-items-center" style="height:33px; width:38px;"></div>
								</div>
								<div>
									<p class="font-sans text-center text-muted" style="letter-spacing: -4.3px;">
										ダッシュボード
									</p>
								</div>
							</a>
							<!-- Hovered -->
							<a href="/admin/dashboard" class="nav-link hovered">
								<div class="mt-3">
									<div class="bg-dashboard-icon-hover d-flex justify-content-center align-items-center" style="height:33px; width:38px;"></div>
								</div>
								<div>
									<p class="fw-normal font-sans text-center text-white " style="letter-spacing: -4.3px;">
										ダッシュボード
									</p>
								</div>
							</a>
						...
						<li class="nav-item-element" style="width:144px; height:103px">
							<!-- Normal -->
							<a href="/admin/accounts" class="nav-link original">
								<div class="mt-3">
									<div class="bg-account-list-icon d-flex justify-content-center align-items-center" style="height:32px; width:36px;"></div>
								</div>
								<div>
									<p class="font-sans text-center text-muted" style="letter-spacing: -4.3px;">
										アカウント
							...
							<!-- Hovered -->
							<a href="/admin/accounts" class="nav-link hovered">
								<div class="mt-3">
									<div class="bg-account-list-icon-hover d-flex justify-content-center align-items-center" style="height:32px; width:36px;"></div>
								</div>
								<div>
									<p class="fw-normal font-sans text-center text-white" style="letter-spacing: -4.3px;">
										アカウント
						...
						<li class="nav-item bg-green-500" style="width:144px; height:99px">
							<a href="/admin/shop/jqadm/search/product?locale=ja" class="nav-link active">
								<div class="mt-3" style="padding-left:2.7rem">
									<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 f0 24 24" height="35px" viewBox="0 0 20 25" width="35px" fill="#FFFFFF">
										<g>
								...
								<div>
									<p class="fw-normal font-sans text-center text-white" style="letter-spacing: -4.5px; margin-right: 5px;">
										ショップ&nbsp;&nbsp;&nbsp;&nbsp;
									</p>
								</div>
							</a>
				...
				<div class="justify-content-center" style="min-width:170px">
					<div id="nav-dropdown" name="nav-dropdown" class="relative d-flex  pe-auto" style="height:28px" >
						<div class="my-auto">
							...
							@endphp
							<p class="text-base h6 fs-6 text-tertiary-500 px-2 pt-1 font-sans truncate" id="companyDropwdownTitle" style="font-size: 1.1rem!important; font-weight: 600!important; text-shadow: 1px 1px 2px #e8e8e8;">@php echo $user['last_name'] . ' ' . $user['first_name'] @endphp</p>
