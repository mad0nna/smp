...
?>
<div class="btn btn-secondary act-help d-none" title="<?= $enc->attr( $this->translate( 'admin', 'Display help texts' ) ) ?>">
...
<?php if( !empty( $actions ) ) : ?>
	<button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split d-none" data-bs-toggle="dropdown"
